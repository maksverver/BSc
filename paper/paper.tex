...
\caption{Eratosthenes/hash table execution time}
...
\caption{Eratosthenes/hash table memory usage}
...
\caption{Eratosthenes/B-tree execution time}
\label{fig-eratosthenes-btree}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=83mm]{fig-eratosthenes-btree_vss}
\caption{Eratosthenes/B-tree memory usage}
\label{fig-eratosthenes-btree}
\end{figure}
...
\caption{Leader2 execution time}
\label{fig-eratosthenes-bender_wctime}
\end{figure}
...
\caption{Peterson_N execution time}
\label{fig-eratosthenes-bender_wctime}
\end{figure}
...
\caption{Peterson_N memory usage}
\label{fig-eratosthenes-bender_wctime}
\end{figure}
