...
with an Intel Xeon E5320 processor (1.86 GHz, 4~MB cache) and 8~GB of main
memory and 2~GB swap file. Although the system is a multiprocessor system
...
experiments, as it seems to perform best even for a relatively small test case.
...
\section{Future work}
[[Measure different data structures]]

[[Measure performance in low memory environments (using disk)]]

[[Mesure cache performance specifically]]
